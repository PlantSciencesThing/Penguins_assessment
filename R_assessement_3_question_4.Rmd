...
The Adelie data for culmen depth and body mass are close to normally distributed, so the linear model performed was appropriate, and the results and therefore reliable.
```{r}
...
Now I will save the figure as a pdf
```{r}
